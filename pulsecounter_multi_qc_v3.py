...
def process_frequency(sdr, freq_hz, writer, live_plot=False, ax_env=None, snr_history=None):
    ...
    try:
        while True:
            ...
            for freq_hz in freqs_hz:
                process_frequency(sdr, freq_hz, writer, live_plot, ax_env, snr_history)
                time.sleep(interval)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Multi-frequency wildlife tag pulse logger with missed peak flag and daily rotation")
